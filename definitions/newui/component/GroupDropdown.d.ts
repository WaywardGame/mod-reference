...
export default abstract class GroupDropdown<ENUM_OBJECT, OTHER_OPTIONS extends string, GROUP extends number, KEYS = keyof ENUM_OBJECT> extends EnumDropdown<ENUM_OBJECT, OTHER_OPTIONS, KEYS> {
    private groups;
    private tooltip?;
    ...
    protected optionMatchesFilterWord(word: string, option: KEYS | OTHER_OPTIONS, text: string): boolean;

...
export declare enum Bindable {
    ...
    GameActions = 16,
    GameContextMenu1 = 17,
    GameContextMenu10 = 18,
    GameContextMenu11 = 19,
    GameContextMenu12 = 20,
    GameContextMenu13 = 21,
    GameContextMenu14 = 22,
    GameContextMenu15 = 23,
    GameContextMenu16 = 24,
    GameContextMenu17 = 25,
    GameContextMenu18 = 26,
    GameContextMenu19 = 27,
    GameContextMenu2 = 28,
    GameContextMenu20 = 29,
    GameContextMenu21 = 30,
    GameContextMenu22 = 31,
    GameContextMenu23 = 32,
    GameContextMenu24 = 33,
    GameContextMenu3 = 34,
    GameContextMenu4 = 35,
    GameContextMenu5 = 36,
    GameContextMenu6 = 37,
    ...
    GameContextMenu8 = 39,
    GameContextMenu9 = 40,
    GameFaceDirection = 41,
    GameFaceDown = 42,
    GameFaceLeft = 43,
    GameFaceRight = 44,
    GameFaceUp = 45,
    GameFullscreen = 46,
    GameHandToggleLeft = 47,
    GameHandToggleRight = 48,
    GameIdle = 49,
    GameInspect = 50,
    GameItemDrop = 51,
    GameItemDropAll = 52,
    GameItemEquipToggle = 53,
    GameItemMenu = 54,
    GameItemMove = 55,
    GameItemQuickMove = 56,
    GameItemQuickMoveAll = 57,
    GameMoreInformation = 58,
    GameMoveDirection = 59,
    GameMoveDown = 60,
    GameMoveLeft = 61,
    GameMoveRight = 62,
    GameMoveUp = 63,
    ...
    GameQuickSlot8 = 72,
    GameQuickSlot9 = 73,
    GameQuickSlotClear = 74,
    GameQuickSlotToggle1 = 75,
    GameQuickSlotToggle2 = 76,
    GameQuickSlotToggle3 = 77,
    GameQuickSlotToggle4 = 78,
    GameQuickSlotToggle5 = 79,
    GameQuickSlotToggle6 = 80,
    GameQuickSlotToggle7 = 81,
    GameQuickSlotToggle8 = 82,
    GameQuickSlotToggle9 = 83,
    GameScreenshotMode = 84,
    GameZoomIn = 85,
    GameZoomOut = 86,
    MenuCancel = 87,
    MenuContextMenu = 88,

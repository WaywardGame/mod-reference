...
export declare enum Bindable {
     ...
     */
    None = 0,
    DeveloperReloadAndContinueGame = 1,
    DeveloperReloadGame = 2,
    DeveloperToggleDeveloperMode = 3,
    DeveloperToggleDeveloperTools = 4,
    DialogCloseAll = 5,
    DialogCrafting = 6,
    DialogDismantle = 7,
    DialogEquipment = 8,
    ...
    DialogInventory = 10,
    DialogMessages = 11,
    DialogMessagesChatFocus = 12,
    DialogMessagesChatSend = 13,
    DialogMessagesChatUnfocus = 14,
    DialogMilestones = 15,
    DialogOptions = 16,
    DialogSkills = 17,
    GameActions = 18,
    GameContextMenu1 = 19,
    GameContextMenu10 = 20,
    GameContextMenu11 = 21,
    GameContextMenu12 = 22,
    GameContextMenu13 = 23,
    GameContextMenu14 = 24,
    GameContextMenu15 = 25,
    GameContextMenu16 = 26,
    GameContextMenu17 = 27,
    GameContextMenu18 = 28,
    GameContextMenu19 = 29,
    GameContextMenu2 = 30,
    GameContextMenu20 = 31,
    GameContextMenu21 = 32,
    GameContextMenu22 = 33,
    GameContextMenu23 = 34,
    GameContextMenu24 = 35,
    GameContextMenu3 = 36,
    GameContextMenu4 = 37,
    GameContextMenu5 = 38,
    GameContextMenu6 = 39,
    ...
    GameContextMenu8 = 41,
    GameContextMenu9 = 42,
    GameFaceDirection = 43,
    GameFaceDown = 44,
    GameFaceLeft = 45,
    GameFaceRight = 46,
    GameFaceUp = 47,
    GameFullscreen = 48,
    GameHandToggleLeft = 49,
    GameHandToggleRight = 50,
    GameIdle = 51,
    GameInspect = 52,
    GameItemDrop = 53,
    GameItemDropAll = 54,
    GameItemEquipToggle = 55,
    GameItemMenu = 56,
    GameItemMove = 57,
    GameItemQuickMove = 58,
    GameItemQuickMoveAll = 59,
    GameMoreInformation = 60,
    GameMoveDirection = 61,
    GameMoveDown = 62,
    GameMoveLeft = 63,
    GameMoveRight = 64,
    GameMoveUp = 65,
    ...
    GameQuickSlot8 = 74,
    GameQuickSlot9 = 75,
    GameQuickSlotClear = 76,
    GameQuickSlotToggle1 = 77,
    GameQuickSlotToggle2 = 78,
    GameQuickSlotToggle3 = 79,
    GameQuickSlotToggle4 = 80,
    GameQuickSlotToggle5 = 81,
    GameQuickSlotToggle6 = 82,
    GameQuickSlotToggle7 = 83,
    GameQuickSlotToggle8 = 84,
    GameQuickSlotToggle9 = 85,
    GameScreenshotMode = 86,
    GameZoomIn = 87,
    GameZoomOut = 88,
    MenuCancel = 89,
    MenuContextMenu = 90,

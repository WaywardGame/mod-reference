...
declare enum Message {
    ...
    NoLongerFeelPainOBeingfBurned = 299,
    ...
    Plant = 343,
    PlantIsFertile = 344,
    PlantIsNotFertile = 345,
    PlantVeryHealthy = 346,
    PlantedInGround = 347,
    PoisonWorkedItsCourse = 348,
    Poisoned = 349,
    PoisonedLostHealth = 350,
    PouredOutWater = 351,
    PouredWaterIntoStill = 352,
    PreservedFood = 353,
    PublishingMod = 354,
    PurifiedWaterInStill = 355,
    RefreshingMods = 356,
    Reinforce = 357,
    RemoveFromQuickslot = 358,
    RemovedBlood = 359,
    Repair = 360,
    RequiredModsMissingWantToContinue = 361,
    RequiredModsNotLoaded = 362,
    RequiresFacingFireSource = 363,
    RequiresFireToBeLit = 364,
    RequiresYouToBeFacingToCraft = 365,
    Rest = 366,
    RestInterrupted = 367,
    Rested = 368,
    Resting = 369,
    ReturnToTitleScreenNoSaveInDailyChallenge = 370,
    ReturnToTitleScreenProgressWillBeSaved = 371,
    ReturnedToCivilization = 372,
    ReturningToCivilizationSetOffAgain = 373,
    RightHand = 374,
    SailedToCivilization = 375,
    SavingGame = 376,
    ScrollProvidedNoUsefulInsight = 377,
    SeaweedFromWater = 378,
    SecondQuarterOfDay = 379,
    SecondQuarterOfNight = 380,
    SeeGrowing = 381,
    SeemsToHaveDrawnEnergy = 382,
    SetTrapOffButNoDamage = 383,
    SetUp = 384,
    ShadowInTheWater = 385,
    Simple = 386,
    Skill = 387,
    SkillHasRaised = 388,
    Slashing = 389,
    SleepInterrupted = 390,
    Sleeping = 391,
    Slept = 392,
    SoilWouldHaveNoEffect = 393,
    SomethingInTheWayOfCarving = 394,
    SomethingInTheWayOfDigging = 395,
    SomethingInTheWayOfDiggingCarveFirst = 396,
    SomethingInTheWayOfGatheringCarveFirst = 397,
    SomethingInTheWayOfFishing = 398,
    SomethingInTheWayOfPlacing = 399,
    SoothedYourBurnInjuries = 400,
    Sort = 401,

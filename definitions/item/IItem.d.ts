...
export declare enum ItemTypeGroup {
    ...
    RawMeat = 844,
    CookedMeat = 845,
    ContainerOfSeawater = 846,
    ContainerOfDesalinatedWater = 847,
    ContainerOfMedicinalWater = 848,
    ContainerOfPurifiedFreshWater = 849,
    ContainerOfUnpurifiedFreshWater = 850,
    Campfire = 851,
    Furnace = 852,
    Kiln = 853,
    WaterStill = 854,
    ...
    Milk = 863,
    Book = 864,
    CoconutContainerOfPotableWater = 865,
    SandCastFlask = 866,
    Glue = 867,
    FireStarter = 868,
    Sand = 869,

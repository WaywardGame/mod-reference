...
declare global {
    ...
    type IterableOfOr<T> = T | IterableOf<T>;
...
export declare function pipeIterable<T>(what?: IterableOf<T>): IterableIterator<T>;
/**

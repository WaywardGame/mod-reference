...
export declare enum UiMessage {
    ...
    MultiplayerRetry = 31,
    MultiplayerServerShutdown = 32,
    MultiplayerSynchronizationError = 33,
    MultiplayerUnableToJoinServer = 34,
    MultiplayerUnknownError = 35,
    MultiplayerVersionMismatch = 36,
    No = 37,
    NoGatherAreYouSureYouWantToDestroy = 38,
    Ok = 39,
    PublishingMod = 40,
    QuittingGame = 41,
    RefreshingMods = 42,
    Rejoin = 43,
    Rename = 44,
    RequiredModsMissingWantToContinue = 45,
    RequiredModsNotLoaded = 46,
    Resting = 47,
    ReturnToTitleScreenNoSaveInDailyChallenge = 48,
    ReturnToTitleScreenProgressWillBeSaved = 49,
    SavingGame = 50,
    Sleeping = 51,
    SteamWorkshop = 52,
    TravelAway = 53,
    UnableToImportSave = 54,
    UnableToLoadRequiredMods = 55,
    UpdatingMod = 56,
    VersionWarning = 57,
    WantToDeleteAllSavedData = 58,
    WantToDeleteThisGame = 59,
    WantToPublishThisMod = 60,
    WantToPublishUpdateToMod = 61,
    WantToUninstallThisMod = 62,
    WaterDoesNotNeedDesalination = 63,
    WelcomeToWayward = 64,
    WhatWouldYouLikeToNameThis = 65,
    Yes = 66,
}

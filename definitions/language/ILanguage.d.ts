...
export declare enum UiMessage {
    ...
    MultiplayerVersionMismatch = 35,
    No = 36,
    NoGatherAreYouSureYouWantToDestroy = 37,
    Ok = 38,
    PublishingMod = 39,
    QuittingGame = 40,
    RefreshingMods = 41,
    Rejoin = 42,
    Rename = 43,
    RequiredModsMissingWantToContinue = 44,
    RequiredModsNotLoaded = 45,
    Resting = 46,
    ReturnToTitleScreenNoSaveInDailyChallenge = 47,
    ReturnToTitleScreenProgressWillBeSaved = 48,
    SavingGame = 49,
    Sleeping = 50,
    SteamWorkshop = 51,
    TravelAway = 52,
    UnableToImportSave = 53,
    UnableToLoadRequiredMods = 54,
    UpdatingMod = 55,
    VersionWarning = 56,
    WantToDeleteAllSavedData = 57,
    WantToDeleteThisGame = 58,
    WantToPublishThisMod = 59,
    WantToPublishUpdateToMod = 60,
    WantToUninstallThisMod = 61,
    WaterDoesNotNeedDesalination = 62,
    WelcomeToWayward = 63,
    WhatWouldYouLikeToNameThis = 64,
    Yes = 65,
}

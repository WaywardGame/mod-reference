...
export declare enum UiMessageStatic {
    ...
    OptionsSaveData = 156,
    OptionsScaleDefault = 157,
    OptionsScaleIn = 158,
    OptionsScaleOut = 159,
    OptionsScreenshotMode = 160,
    OptionsScreenshotModeTooltip = 161,
    OptionsSkipIntro = 162,
    OptionsSkipIntroTooltip = 163,
    OptionsVisionDither = 164,
    OptionsVisionFade = 165,
    OptionsWarnOnDangerousActions = 166,
    OptionsWarnOnDangerousActionsTooltip = 167,
    OptionsWarnWhenBreakingItems = 168,
    OptionsWarnWhenBreakingItemsTooltip = 169,
    OptionsWindowedMode = 170,
    OptionsWorldTooltips = 171,
    OptionsWorldTooltipsTooltip = 172,
    OptionsZoomIn = 173,
    OptionsZoomOnScroll = 174,
    OptionsZoomOnScrollTooltip = 175,
    OptionsZoomOut = 176,
    Overburdened = 177,
    Poisoned = 178,
    PreviousHint = 179,
    ...
    Version = 196,
    Weight = 197,
    WindowTitleContainer = 198,
    WindowTitleCrafting = 199,
    WindowTitleEquipment = 200,
    WindowTitleHighscores = 201,
    WindowTitleInventory = 202,
    WindowTitleMap = 203,
    WindowTitleMessages = 204,
    WindowTitleMilestones = 205,
    WindowTitleOptions = 206,
    WindowTitleSkills = 207,
}

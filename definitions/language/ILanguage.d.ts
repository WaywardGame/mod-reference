...
export declare enum UiMessage {
    ...
    MultiplayerLostConnection = 27,
    MultiplayerRetry = 28,
    MultiplayerServerShutdown = 29,
    MultiplayerSynchronizationError = 30,
    MultiplayerVersionMismatch = 31,
    No = 32,
    Ok = 33,
    PublishingMod = 34,
    QuittingGame = 35,
    ...
    Rejoin = 37,
    Rename = 38,
    RequiredModsMissingWantToContinue = 39,
    RequiredModsNotLoaded = 40,
    Resting = 41,
    ReturnToTitleScreenNoSaveInDailyChallenge = 42,
    ReturnToTitleScreenProgressWillBeSaved = 43,
    SavingGame = 44,
    Sleeping = 45,
    SteamWorkshop = 46,
    TravelAway = 47,
    UnableToImportSave = 48,
    UnableToLoadRequiredMods = 49,
    UpdatingMod = 50,
    VersionWarning = 51,
    WantToDeleteAllSavedData = 52,
    WantToDeleteThisGame = 53,
    WantToPublishThisMod = 54,
    WantToPublishUpdateToMod = 55,
    WantToUninstallThisMod = 56,
    WaterDoesNotNeedDesalination = 57,
    WelcomeToWayward = 58,
    WhatWouldYouLikeToNameThis = 59,
    Yes = 60,
}

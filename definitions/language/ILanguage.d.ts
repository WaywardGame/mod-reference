...
export declare enum UiMessage {
    ...
    MultiplayerRetry = 29,
    MultiplayerServerShutdown = 30,
    MultiplayerSynchronizationError = 31,
    MultiplayerVersionMismatch = 32,
    No = 33,
    NoGatherAreYouSureYouWantToDestroy = 34,
    Ok = 35,
    PublishingMod = 36,
    QuittingGame = 37,
    RefreshingMods = 38,
    Rejoin = 39,
    Rename = 40,
    RequiredModsMissingWantToContinue = 41,
    RequiredModsNotLoaded = 42,
    Resting = 43,
    ReturnToTitleScreenNoSaveInDailyChallenge = 44,
    ReturnToTitleScreenProgressWillBeSaved = 45,
    SavingGame = 46,
    Sleeping = 47,
    SteamWorkshop = 48,
    TravelAway = 49,
    UnableToImportSave = 50,
    UnableToLoadRequiredMods = 51,
    UpdatingMod = 52,
    VersionWarning = 53,
    WantToDeleteAllSavedData = 54,
    WantToDeleteThisGame = 55,
    WantToPublishThisMod = 56,
    WantToPublishUpdateToMod = 57,
    WantToUninstallThisMod = 58,
    WaterDoesNotNeedDesalination = 59,
    WelcomeToWayward = 60,
    WhatWouldYouLikeToNameThis = 61,
    Yes = 62,
}

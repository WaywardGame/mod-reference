...
export declare enum UiMessage {
    ...
    MultiplayerConnecting = 25,
    MultiplayerFailedToConnect = 26,
    MultiplayerFailedToLoadMods = 27,
    MultiplayerLostConnection = 28,
    MultiplayerMaxPlayerCountExceeded = 29,
    MultiplayerRetry = 30,
    MultiplayerServerShutdown = 31,
    MultiplayerSynchronizationError = 32,
    MultiplayerVersionMismatch = 33,
    No = 34,
    NoGatherAreYouSureYouWantToDestroy = 35,
    Ok = 36,
    PublishingMod = 37,
    QuittingGame = 38,
    RefreshingMods = 39,
    Rejoin = 40,
    Rename = 41,
    RequiredModsMissingWantToContinue = 42,
    RequiredModsNotLoaded = 43,
    Resting = 44,
    ReturnToTitleScreenNoSaveInDailyChallenge = 45,
    ReturnToTitleScreenProgressWillBeSaved = 46,
    SavingGame = 47,
    Sleeping = 48,
    SteamWorkshop = 49,
    TravelAway = 50,
    UnableToImportSave = 51,
    UnableToLoadRequiredMods = 52,
    UpdatingMod = 53,
    VersionWarning = 54,
    WantToDeleteAllSavedData = 55,
    WantToDeleteThisGame = 56,
    WantToPublishThisMod = 57,
    WantToPublishUpdateToMod = 58,
    WantToUninstallThisMod = 59,
    WaterDoesNotNeedDesalination = 60,
    WelcomeToWayward = 61,
    WhatWouldYouLikeToNameThis = 62,
    Yes = 63,
}

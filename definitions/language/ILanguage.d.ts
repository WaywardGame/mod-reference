...
export declare enum UiMessage {
    ...
    RefreshingMods = 33,
    Rename = 34,
    RequiredModsMissingWantToContinue = 35,
    RequiredModsNotLoaded = 36,
    Resting = 37,
    ReturnToTitleScreenNoSaveInDailyChallenge = 38,
    ReturnToTitleScreenProgressWillBeSaved = 39,
    SavingGame = 40,
    Sleeping = 41,
    SteamWorkshop = 42,
    TravelAway = 43,
    UnableToImportSave = 44,
    UnableToLoadRequiredMods = 45,
    UpdatingMod = 46,
    VersionWarning = 47,
    WantToDeleteAllSavedData = 48,
    WantToDeleteThisGame = 49,
    WantToPublishThisMod = 50,
    WantToPublishUpdateToMod = 51,
    WantToUninstallThisMod = 52,
    WelcomeToWayward = 53,
    WhatWouldYouLikeToNameItem = 54,
    Yes = 55,
}

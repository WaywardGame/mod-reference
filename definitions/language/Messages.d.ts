...
export declare enum Message {
    ...
    YouHarvested = 591,
    YouHaveDied = 592,
    YouHaveHealedCreature = 593,
    YouHaveKilled = 594,
    YouHaveReleased = 595,
    YouHaveTamed = 596,
    YouNoticeBecomeEnraged = 597,
    YouNoticeDying = 598,
    YouNoticeFertilityDecreasing = 599,
    YouNoticeFertilityIncreasing = 600,
    YouNoticeGrowing = 601,
    YouNoticeLavaTurn = 602,
    YouNoticePerish = 603,
    YouNoticeStumbleInjureItself = 604,
    YouNoticeWoundsClosing = 605,
    YouNoticeZombieHorde = 606,
    YouOfferedToCreature = 607,
    YouOpen = 608,
    YouPacked = 609,
    YouPickedUp = 610,
    YouRepair = 611,
    YourFist = 612,
    YourHands = 613,
    YourRubbingNoEffect = 614,
    YouRub = 615,
    YouSalvaged = 616,
    YouSee = 617,
    YouSeeAnAberrant = 618,
    YouSeeDrop = 619,
    YouSeeEngulfFire = 620,
    YouSeeLay = 621,
    YouSeeLayingTrap = 622,
    YouSeeSpewLava = 623,
    YouSeeSpitAcid = 624,
    YouSeeSpringForth = 625,
    YouSeeSummon = 626,
    YouSeeSwampFlood = 627,
    YouSeparate = 628,
    YouSetTheTrapOff = 629,
    YouThrew = 630,
    YouTilled = 631,
    YouUnequip = 632,
    YouUsed = 633,

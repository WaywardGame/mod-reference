...
export declare enum Message {
    ...
    YouFailedTo = 603,
    YouFailedToHeal = 604,
    YouFailedToHealCreature = 605,
    YouFire = 606,
    YouGathered = 607,
    YouHarvested = 608,
    YouHaveDied = 609,
    YouHaveEnabledDisabled = 610,
    YouHaveHealedCreature = 611,
    YouHaveKilled = 612,
    YouHaveReleased = 613,
    YouHaveTamed = 614,
    YouNoticeBecomeEnraged = 615,
    YouNoticeDying = 616,
    YouNoticeFertilityDecreasing = 617,
    YouNoticeFertilityIncreasing = 618,
    YouNoticeGrowing = 619,
    YouNoticeLavaCooling = 620,
    YouNoticePerish = 621,
    YouNoticeStumbleInjureItself = 622,
    YouNoticeWoundsClosing = 623,
    YouNoticeZombieHorde = 624,
    YouOfferedToCreature = 625,
    YouOpen = 626,
    YouPacked = 627,
    YouPickedUp = 628,
    YouRepair = 629,
    YourFist = 630,
    YourHands = 631,
    YourRubbingNoEffect = 632,
    YouRub = 633,
    YouSalvaged = 634,
    YouSee = 635,
    YouSeeAnAberrant = 636,
    YouSeeDrop = 637,
    YouSeeEngulfFire = 638,
    YouSeeLay = 639,
    YouSeeLayingTrap = 640,
    YouSeeSpewLava = 641,
    YouNoticeLavaHardening = 642,
    YouSeeSpitAcid = 643,
    YouSeeSpringForth = 644,
    YouSeeSummon = 645,
    YouSeeSwampFlood = 646,
    YouSeparate = 647,
    YouSetTheTrapOff = 648,
    YouThrew = 649,
    YouTilled = 650,
    YouUnequip = 651,
    YouUsed = 652,

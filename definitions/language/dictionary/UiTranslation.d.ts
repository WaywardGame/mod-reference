...
declare enum UiTranslation {
    ...
    MiscBindableOr = 671,
    MiscBindableNoBindings = 672,
    SteamworksInterruptURLOpenedInBrowser = 673,
    SteamworksInterruptURLOpenedInBrowserDescription = 674,
    SteamworksInterruptWorkshopOpenedInBrowser = 675,
    SteamworksInterruptWorkshopOpenedInBrowserDescription = 676,
    SteamworksInterruptModWithNameAlreadyExists = 677,
    SteamworksInterruptModWithNameAlreadyExistsDescription = 678,
    SteamworksInterruptModImportSaveGameFailure = 679,
    SteamworksInterruptModImportSaveGameFailureDescription = 680,
    SteamworksInterruptModImportedSaveGame = 681,
    SteamworksInterruptModImportedSaveGameDescription = 682,
    SteamworksInterruptLoadingRefreshingMods = 683,
    SteamworksInterruptLoadingRefreshingModsDescription = 684,
    SteamworksInterruptOpenFolderFailure = 685,
    SteamworksInterruptOpenFolderFailureDescription = 686,
    DifficultyOptionsPeaceful = 687,
    ...
    DifficultyOptionsStatInitial = 699,
    DifficultyOptionsStatMax = 700,
    DifficultyOptionsStatMultiplier = 701,
    DifficultyOptionsStatusEffectStartWith = 702,
    DifficultyOptionsStatusEffectUntreatable = 703,
    DifficultyOptionsStatusEffectPassChanceMultiplier = 704,
    DifficultyOptionsNoRandomSkills = 705,
    DifficultyOptionsSkillGainMultiplier = 706,
    DifficultyOptionsSkillInitial = 707,
    DifficultyOptionsStatusEffectPermanent = 708,
    DifficultyOptionsStatusEffectRateMultiplier = 709,
    DifficultyOptionsStatusEffectMultiplier = 710,
    EquipmentBack = 711,
    EquipmentBelt = 712,
    EquipmentChest = 713,
    EquipmentFeet = 714,
    EquipmentHands = 715,
    EquipmentHead = 716,
    EquipmentLeftHand = 717,
    EquipmentLeftHandOption = 718,
    EquipmentLegs = 719,
    EquipmentNeck = 720,
    EquipmentRightHand = 721,
    EquipmentRightHandOption = 722,
    EquipmentUse = 723,
    HudFilter = 724,
    QuickSlot1 = 725,
    QuickSlot2 = 726,
    ...
    TabDismantle = 735,
    Version = 736,
    WindowTitleContainer = 737,
    WindowTitleCrafting = 738,
    WindowTitleEquipment = 739,
    WindowTitleInventory = 740
}

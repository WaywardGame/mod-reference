...
declare enum Message {
    ...
    YouEquip = 659,
    YouFailedTo = 660,
    YouFailedToExtinguishedFireFully = 661,
    YouFailedToHeal = 662,
    YouFailedToHealOther = 663,
    YouFire = 664,
    YouGathered = 665,
    YouGatheredAndDropped = 666,
    YouHardenedCooledLava = 667,
    YouHarvested = 668,
    YouHarvestedAndDropped = 669,
    YouHaveDied = 670,
    YouHaveEnabledDisabled = 671,
    YouHaveHealedOther = 672,
    YouHaveKilled = 673,
    YouHaveReleased = 674,
    YouHaveTamed = 675,
    YouNeedMoreCredit = 676,
    YouNoticeBecomeEnraged = 677,
    YouNoticeDying = 678,
    YouNoticeFertilityDecreasing = 679,
    YouNoticeFertilityIncreasing = 680,
    YouNoticeGrowing = 681,
    YouNoticeLavaCooling = 682,
    YouNoticeLavaHardening = 683,
    YouNoticePerish = 684,
    YouNoticeStumbleInjureItself = 685,
    YouNoticeTakeFromGround = 686,
    YouNoticeWoundsClosing = 687,
    YouNoticeZombieHorde = 688,
    YouOfferedToCreature = 689,
    YouOpen = 690,
    YouPacked = 691,
    YouPickedUp = 692,
    YouRepair = 693,
    ...
    YourInventory = 697,
    YourLowSkill = 698,
    YourModerateSkill = 699,
    YourRubbingNoEffect = 700,
    YouRub = 701,
    YouSalvaged = 702,
    YouSee = 703,
    YouSeeAnAberrant = 704,
    YouSeeDrop = 705,
    YouSeeEngulfFire = 706,
    YouSeeHelpingPlant = 707,
    YouSeeLay = 708,
    YouSeeLayingTrap = 709,
    YouSeeSpewLava = 710,
    YouSeeSpitAcid = 711,
    YouSeeSpringForth = 712,
    YouSeeSummon = 713,
    YouSeeSwampFlood = 714,
    YouSeeTrampling = 715,
    YouSeparate = 716,
    YouSetTheTrapOff = 717,
    YouThrew = 718,
    YouTilled = 719,
    YouUnequip = 720,
    YouUsed = 721

...
declare enum Message {
    ...
    With = 642,
    WithYouSee = 643,
    WorkingYourselfIntoExhaustion = 644,
    WorkingYourselfIntoExhaustionAndDrowning = 645,
    YouApplied = 646,
    YouAte = 647,
    YouBeginResting = 648,
    YouCannotDoThatYet = 649,
    YouCooledLava = 650,
    YouCrafted = 651,
    YouDied = 652,
    YouDisassembled = 653,
    ...
    YouEquip = 656,
    YouFailedTo = 657,
    YouFailedToExtinguishedFireFully = 658,
    YouFailedToHeal = 659,
    YouFailedToHealOther = 660,
    YouFire = 661,
    YouGathered = 662,
    YouGatheredAndDropped = 663,
    YouHardenedCooledLava = 664,
    YouHarvested = 665,
    YouHarvestedAndDropped = 666,
    YouHaveDied = 667,
    YouHaveEnabledDisabled = 668,
    YouHaveHealedOther = 669,
    YouHaveKilled = 670,
    YouHaveReleased = 671,
    YouHaveTamed = 672,
    YouNeedMoreCredit = 673,
    YouNoticeBecomeEnraged = 674,
    YouNoticeDying = 675,
    YouNoticeFertilityDecreasing = 676,
    YouNoticeFertilityIncreasing = 677,
    YouNoticeGrowing = 678,
    YouNoticeLavaCooling = 679,
    YouNoticeLavaHardening = 680,
    YouNoticePerish = 681,
    YouNoticeStumbleInjureItself = 682,
    YouNoticeTakeFromGround = 683,
    YouNoticeWoundsClosing = 684,
    YouNoticeZombieHorde = 685,
    YouOfferedToCreature = 686,
    YouOpen = 687,
    YouPacked = 688,
    YouPickedUp = 689,
    YouRepair = 690,
    ...
    YourInventory = 694,
    YourLowSkill = 695,
    YourModerateSkill = 696,
    YourRubbingNoEffect = 697,
    YouRub = 698,
    YouSalvaged = 699,
    YouSee = 700,
    YouSeeAnAberrant = 701,
    YouSeeDrop = 702,
    YouSeeEngulfFire = 703,
    YouSeeHelpingPlant = 704,
    YouSeeLay = 705,
    YouSeeLayingTrap = 706,
    YouSeeSpewLava = 707,
    YouSeeSpitAcid = 708,
    YouSeeSpringForth = 709,
    YouSeeSummon = 710,
    YouSeeSwampFlood = 711,
    YouSeeTrampling = 712,
    YouSeparate = 713,
    YouSetTheTrapOff = 714,
    YouThrew = 715,
    YouTilled = 716,
    YouUnequip = 717,
    YouUsed = 718

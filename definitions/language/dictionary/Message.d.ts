...
declare enum Message {
    ...
    WellIsDry = 641,
    WellIsFull = 642,
    WildGoatRefusedToBeMilked = 643,
    WillNotTrade = 644,
    With = 645,
    WithYouSee = 646,
    WorkingYourselfIntoExhaustion = 647,
    WorkingYourselfIntoExhaustionAndDrowning = 648,
    YouApplied = 649,
    YouAte = 650,
    YouBeginResting = 651,
    YouCannotDoThatYet = 652,
    YouCooledLava = 653,
    YouCrafted = 654,
    YouDied = 655,
    YouDisassembled = 656,
    ...
    YouEquip = 660,
    YouFailedTo = 661,
    YouFailedToExtinguishedFireFully = 662,
    YouFailedToHeal = 663,
    YouFailedToHealOther = 664,
    YouFire = 665,
    YouGathered = 666,
    YouGatheredAndDropped = 667,
    YouHardenedCooledLava = 668,
    YouHarvested = 669,
    YouHarvestedAndDropped = 670,
    YouHaveDied = 671,
    YouHaveEnabledDisabled = 672,
    YouHaveHealedOther = 673,
    YouHaveKilled = 674,
    YouHaveReleased = 675,
    YouHaveTamed = 676,
    YouNeedMoreCredit = 677,
    YouNoticeBecomeEnraged = 678,
    YouNoticeDying = 679,
    YouNoticeFertilityDecreasing = 680,
    YouNoticeFertilityIncreasing = 681,
    YouNoticeGrowing = 682,
    YouNoticeLavaCooling = 683,
    YouNoticeLavaHardening = 684,
    YouNoticePerish = 685,
    YouNoticeStumbleInjureItself = 686,
    YouNoticeTakeFromGround = 687,
    YouNoticeWoundsClosing = 688,
    YouNoticeZombieHorde = 689,
    YouOfferedToCreature = 690,
    YouOpen = 691,
    YouPacked = 692,
    YouPickedUp = 693,
    YouRepair = 694,
    ...
    YourInventory = 698,
    YourLowSkill = 699,
    YourModerateSkill = 700,
    YourRubbingNoEffect = 701,
    YouRub = 702,
    YouSalvaged = 703,
    YouSee = 704,
    YouSeeAnAberrant = 705,
    YouSeeDrop = 706,
    YouSeeEngulfFire = 707,
    YouSeeHelpingPlant = 708,
    YouSeeLay = 709,
    YouSeeLayingTrap = 710,
    YouSeeSpewLava = 711,
    YouSeeSpitAcid = 712,
    YouSeeSpringForth = 713,
    YouSeeSummon = 714,
    YouSeeSwampFlood = 715,
    YouSeeTrampling = 716,
    YouSeparate = 717,
    YouSetTheTrapOff = 718,
    YouThrew = 719,
    YouTilled = 720,
    YouUnequip = 721,
    YouUsed = 722

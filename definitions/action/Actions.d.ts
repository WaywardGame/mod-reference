...
declare const actionDescriptions: {
    ...
    [ActionType.Attack]: import("./Action").Action<[[ActionArgument.AttackType, ActionArgument.Undefined], [ActionArgument.Item, ActionArgument.Undefined]], import("../player/IPlayer").IPlayer | import("../npc/INPC").INPC, Promise<void>>;
    ...
    [ActionType.Decode]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer | import("../npc/INPC").INPC, void>;

...
declare const actionDescriptions: {
    ...
    [ActionType.Disassemble]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Dismantle]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.DrawMap]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.DrinkCure]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.DrinkInFront]: import("./Action").Action<[], import("../player/IPlayer").IPlayer, void>;
    [ActionType.DrinkItem]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Drop]: import("./Action").Action<[ActionArgument.ItemNearby, [ActionArgument.Boolean, ActionArgument.Undefined], [ActionArgument.Boolean, ActionArgument.Undefined]], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Eat]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    ...
    [ActionType.Extinguish]: import("./Action").Action<[ActionArgument.ItemInventory], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Fire]: import("./Action").Action<[ActionArgument.ItemInventory], import("../player/IPlayer").IPlayer, void>;
    ...
    [ActionType.GatherMilk]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.GatherTreasure]: import("./Action").Action<[[ActionArgument.ItemNearby, ActionArgument.Undefined]], import("../player/IPlayer").IPlayer, void>;
    [ActionType.GatherWater]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Grasp]: import("./Action").Action<[ActionArgument.ItemInventory], import("../player/IPlayer").IPlayer, void>;
    ...
    [ActionType.Ignite]: import("./Action").Action<[ActionArgument.ItemInventory], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Inspect]: import("./Action").Action<[ActionArgument.Vector3], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Jump]: import("./Action").Action<[], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Learn]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.LockPick]: import("./Action").Action<[ActionArgument.ItemInventory], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Move]: import("./Action").Action<[ActionArgument.Direction], import("../player/IPlayer").IPlayer, void>;
    [ActionType.MoveItem]: import("./Action").Action<[[ActionArgument.ItemNearby, ActionArgument.Undefined], [ActionArgument.Container, ActionArgument.Undefined], [ActionArgument.Container, ActionArgument.Undefined], [ActionArgument.ItemType, ActionArgument.Undefined], [ActionArgument.ItemQuality, ActionArgument.Undefined]], import("../player/IPlayer").IPlayer, void>;
    ...
    [ActionType.OpenBottle]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    ...
    [ActionType.PickupAllItems]: import("./Action").Action<[], import("../player/IPlayer").IPlayer, void>;
    [ActionType.PickupItem]: import("./Action").Action<[], import("../player/IPlayer").IPlayer, void>;
    [ActionType.PlaceDown]: import("./Action").Action<[ActionArgument.Item], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Plant]: import("./Action").Action<[ActionArgument.ItemInventory], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Pour]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.PourOnYourself]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Preserve]: import("./Action").Action<[ActionArgument.ItemNearby, [ActionArgument.ItemNearby, ActionArgument.Undefined]], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Read]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Reinforce]: import("./Action").Action<[ActionArgument.ItemNearby, [ActionArgument.ItemNearby, ActionArgument.Undefined]], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Release]: import("./Action").Action<[], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Rename]: import("./Action").Action<[[ActionArgument.ItemNearby, ActionArgument.Doodad, ActionArgument.Creature], ActionArgument.String], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Repair]: import("./Action").Action<[ActionArgument.ItemNearby, [ActionArgument.ItemNearby, ActionArgument.Doodad, ActionArgument.Undefined]], import("../player/IPlayer").IPlayer, void>;
    ...
    [ActionType.RubClockwise]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.RubCounterclockwise]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    ...
    [ActionType.SetDown]: import("./Action").Action<[ActionArgument.ItemInventory], import("../player/IPlayer").IPlayer, void>;
    ...
    [ActionType.Sling]: import("./Action").Action<[ActionArgument.Item], import("../npc/INPC").INPC | import("../player/IPlayer").IPlayer, void>;
    [ActionType.SmotherFire]: import("./Action").Action<[ActionArgument.ItemInventory], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Squeeze]: import("./Action").Action<[ActionArgument.ItemInventory], import("../player/IPlayer").IPlayer, void>;
    [ActionType.StartFire]: import("./Action").Action<[ActionArgument.ItemInventory, [ActionArgument.ItemInventory, ActionArgument.Undefined]], import("../player/IPlayer").IPlayer, void>;
    [ActionType.StokeFire]: import("./Action").Action<[ActionArgument.ItemInventory], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Tame]: import("./Action").Action<[], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Teleport]: import("./Action").Action<[ActionArgument.ItemInventory], import("../player/IPlayer").IPlayer, void>;
    [ActionType.TellTime]: import("./Action").Action<[ActionArgument.ItemNearby], import("../player/IPlayer").IPlayer, void>;
    [ActionType.Throw]: import("./Action").Action<[ActionArgument.ItemNearby], import("../npc/INPC").INPC | import("../player/IPlayer").IPlayer, void>;
    ...
    [ActionType.UpdateDirection]: import("./Action").Action<[ActionArgument.Direction, [ActionArgument.Boolean, ActionArgument.Undefined]], import("../player/IPlayer").IPlayer, void>;
